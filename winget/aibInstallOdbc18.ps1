<#
.SYNOPSIS
    Azure Image Builder script to install Microsoft ODBC 18 using Winget.

.DESCRIPTION
    This script:
    - Assumes Winget is already installed.
    - Dynamically locates Winget to ensure execution.
    - Installs Microsoft ODBC 18 machine-wide.
...
Write-Host "*** AIB CUSTOMIZER PHASE: Installing Microsoft ODBC 18 ***"
...
$wingetAppId = "Microsoft.msodbcsql.18"
$wingetAppName = "Microsoft ODBC 18"

# Install Microsoft ODBC 18 using Winget (Machine-Wide)
