<#
.SYNOPSIS
    Azure Image Builder script to install Octoparse using Winget.

.DESCRIPTION
    This script:
    - Assumes Winget is already installed.
    - Dynamically locates Winget to ensure execution.
    - Installs Octoparse machine-wide.
...
Write-Host "*** AIB CUSTOMIZER PHASE: Installing Octoparse ***"
...
$wingetAppId = "OctopusData.Octoparse"
$wingetAppName = "Octoparse"

# Install Octoparse using Winget (Machine-Wide)
