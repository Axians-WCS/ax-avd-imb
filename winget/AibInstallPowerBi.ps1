<#
.SYNOPSIS
    Azure Image Builder script to install Microsoft Power BI Desktop using Winget.

.DESCRIPTION
    This script:
    - Assumes Winget is already installed and initialized.
    - Installs Microsoft Power BI Desktop.
...
Write-Host "*** AIB CUSTOMIZER PHASE: Installing Microsoft Power BI Desktop ***"
...
$wingetAppId = "Microsoft.PowerBI"
$wingetAppName = "Microsoft Power BI Desktop"
